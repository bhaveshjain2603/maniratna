...
function Contact() {
  ...
  const generalWhatsappMessage = encodeURIComponent(
    `Hello MANIRATNA JEWELS ✨

    I recently came across your beautiful jewellery collections and was truly impressed by the craftsmanship and elegance of your designs.

    I would love to know more about your collections and explore how we can connect further.

    Looking forward to hearing from you.`
  );

  const businessWhatsappMessage = encodeURIComponent(
    `Hello MANIRATNA JEWELS ✨

    Your jewellery designs beautifully reflect tradition, elegance, and timeless craftsmanship.

    I’m interested in exploring a business partnership / bulk order opportunity with your brand and would love to discuss this further.
      ...
      <div className="grid gap-10 md:grid-cols-2">
        ...
        <div className="space-y-6">
          ...
          <div className="border border-[#e6d9cf] bg-[#fff8f4] p-8 space-y-6 rounded-lg shadow-sm">
            ...
            {/* CTA */}
            <a
              href={`https://wa.me/919448793711?text=${generalWhatsappMessage}`}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4 py-6">
          ...
          <div className="relative w-full max-w-lg sm:max-w-xl md:max-w-2xl bg-white shadow-lg rounded-lg overflow-hidden max-h-[90vh] flex flex-col">
            ...
            <div className="p-6 sm:p-8 overflow-y-auto">
              ...
              {/* CTA */}
              <a
                href={`https://wa.me/919448793711?text=${businessWhatsappMessage}`}
