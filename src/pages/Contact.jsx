        ...
        <div className="space-y-6">
          ...
          <div className="border border-[#e6d9cf] bg-[#fff8f4] p-8 space-y-6 rounded-lg shadow-sm">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 justify-center border border-[#b28c49] bg-[#25d366] text-white py-3 font-semibold hover:bg-[#128c7e] rounded-md transition"
            >
